...
def find_support(data, allfile_name, per_episode_num):
    ...
    query_dfs = [] #query集
    query_df = pd.DataFrame(data=None, columns=range(122))
    support_df = pd.DataFrame(data=None, columns=range(122))
...
if __name__ == '__main__':
        ...
        ###把一个文件按类别分开后分成40个文件
        # train_path = 'D:/Users/oyyk/PycharmProjects/F_G_P/KDD-dataprepro/NSL-KDD_encoded&pca_traindata.csv'
        # test_path = 'D:/Users/oyyk/PycharmProjects/F_G_P/KDD-dataprepro/NSL-KDD_encoded&pca_testdata.csv'
        # test_file_name = 'D:/Users/oyyk/PycharmProjects/F_G_P/kdd_data/3-4-pca/test/'
        # train_file_name = 'D:/Users/oyyk/PycharmProjects/F_G_P/kdd_data/3-4-pca/train/'
        #
        ...
        output_file = 'D:/Users/oyyk/PycharmProjects/F_G_P/data/RawData/output/kdd_supportsets_1shot/'
